// Temporary packaging script: packages from ./build_new (the pre-existing ./build
// dir from a prior session cannot be cleaned in this sandbox). Same logic as package.js.
...
const buildDir = path.resolve(process.cwd(), 'build_v134');
